...
function updatePlayerControls() {
  ...
  // Player 1 (WASD)
  if (selectedCharacter1 === "mouse") {
    tempMouse = new Player(200, 100, mouse, true, 87, 83, 65, 68, 80, 80); // W,S,A,D
  } else {
    tempBird = new Player(100, 100, bird, false, 87, 83, 65, 68, 150, 150); // W,S,A,D
  }

  // Player 2 (Arrow Keys)
  if (selectedCharacter2 === "mouse") {
    if (!tempMouse) {
      tempMouse = new Player(200, 100, mouse, true, UP_ARROW, DOWN_ARROW, LEFT_ARROW, RIGHT_ARROW, 80, 80);
    } else {
      // Prevent duplicate control binding
      tempBird = new Player(100, 100, bird, false, UP_ARROW, DOWN_ARROW, LEFT_ARROW, RIGHT_ARROW, 150, 150);
    }
  } else {
    if (!tempBird) {
      tempBird = new Player(100, 100, bird, false, UP_ARROW, DOWN_ARROW, LEFT_ARROW, RIGHT_ARROW, 150, 150);
